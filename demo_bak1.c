...
//    if (frame_idx < 10) {  // 仅打印前10帧，避免刷屏
//            xil_printf("[DECODE] Frame %2d (%s) -> B0=%02X B1=%02X B2=%02X B3=%02X B4=%02X\r\n",
//                       (int)frame_idx,
...
//            const size_t total_frames=KWS_DMA_TRANSFER_BYTES/I2S_BYTES_PER_FRAME;
//
//            save_kws_audio_to_sd("0:/record_dma.raw", dma_bytes, 96000*2, 96000);
//            unpack_i2s_frames_to_q31_le_safe(dma_bytes,total_frames,gMicMono96k);
//
//            /* ===== Debug: 打印DMA内存中原始字节顺序 ===== */
//                xil_printf("[DEBUG] DMA memory dump (first 10 frames):\r\n");
//                for (int i = 0; i < 10; i++) {
//                    xil_printf("[I2S] Frame %2d bytes (actual): %02X %02X %02X %02X %02X\r\n",
//                               i,
//                               dma_bytes[i*I2S_BYTES_PER_FRAME + 0],
//                               dma_bytes[i*I2S_BYTES_PER_FRAME + 1],
//                               dma_bytes[i*I2S_BYTES_PER_FRAME + 2],
//                               dma_bytes[i*I2S_BYTES_PER_FRAME + 3],
//                               dma_bytes[i*I2S_BYTES_PER_FRAME + 4]);
//                }
//
